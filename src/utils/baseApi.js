...
const API = {
    ...
    BORROWERS: BASE_URL + '/api/v1/borrowers/',
    BORROWERS_STATUS: BASE_URL + '/api/v1/borrowers/updateStatus',
    BORROWERS_PRODUCTS_SYNC: BASE_URL + '/api/v1/borrowers/{borrower}/products/sync',
    BORROWERS_ASSIGN_CREDIT_LIMIT: BASE_URL + '/api/v1/borrowers/{borrower}/assignCreditLimit',
    BORROWERS_ASSIGN_FINANCING_POLICY: BASE_URL + '/api/v1/borrowers/{borrower}/assignFinancingPolicy',
    BORROWERS_SHIPPER_NAME: BASE_URL + '/api/v1/borrower/shipper-names',
